...
PIRHeartbeatInfo = t.Struct.define([
    ["sequence", t.ui8],
    ["hardwareVersion", t.ui8],
    ["softwareVersion", t.ui8],
    ["battery", t.ui16],
])
...
client.on("connect", async function () {
    ...
    client.subscribe(`gw-event/received_data/+/+/+/5/7`, function (err) {
        if (!err) {
        } else {
...
client.on("message", async function (topic, message, packet) {
    ...
    var pirHeartbeatMsg = PIRHeartbeatInfo.unpack(new t.Pointer(wirepasMessage.wirepas.packet_received_event.payload, 0))


    console.log(serialNumber, pirHeartbeatMsg);
})